...
echo "folder_name,study_instance_uid,series_instance_uid,patient_id,patient_name,study_date,series_date,study_description,series_description,hospital,manufacturer,patientage,patientsex,SliceThickness,ManufacturerModelName,imagecount" >> "$root"/all_case_info.csv
    ...
    do  
        ...
        then
            ...
            then
                ...
                manmodelname=`dcmdump -L --search 0008,1090 $firstdcm |  awk -F '[' '{print $2}'| awk -F ']' '{print $1}'`
                slicethickness=`dcmdump -L --search 0018,0050 $firstdcm |  awk -F '[' '{print $2}'| awk -F ']' '{print $1}'`
                
                sleep 1s

                line="$case,$study_instance_uid,$series_instance_uid,$patient_id,$patient_name,$study_date,$series_date,$study_description,$series_description,$hospital,$manufacturer,$patientage,$patientsex, $slicethickness, $manmodelname, $dcmcount"
